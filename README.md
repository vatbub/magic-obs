...
2. Download the
   launcher [here](https://oss.sonatype.org/content/repositories/snapshots/com/github/vatbub/magic-obs-bootstrap/1.0-SNAPSHOT/magic-obs-bootstrap-1.0-20220404.002322-34-jar-with-dependencies.jar)
   .
